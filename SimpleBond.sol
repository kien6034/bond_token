...
contract SimpleBond is ISimpleBond, Ownable {
   ...
   mapping(uint256 => address) bonds;             // id -> address
   mapping(uint256 => uint256) maturities;        // nonce -> maturity period 
   mapping(uint256 => uint256) couponsRedeemed;   // 
   mapping(address => uint256) bondsAmount;       // address -> total bond amount of that address
   ...
   */
   ...
   function changeLoopLimit(uint256 _loopLimit) public virtual override onlyOwner {
   ...
   */
   ...
   function mintBond(address buyer, uint256 _bondsAmount) public virtual override onlyOwner {
   ...
   */
   ...
   function redeemCoupons(uint256[] memory _bonds) public virtual override {
   ...
   */
   ...
   function transfer(address receiver, uint256[] memory _bonds) public virtual override {
   ...
   */
   ...
   function donate() public payable virtual override {
   ...
   */
   ...
   function getLastTimeRedeemed(uint256 bond) public view virtual override returns (uint256) {
   ...
   */
   ...
   function getBondOwner(uint256 bond) public view virtual override returns (address) {
   ...
   */
   ...
   function getRemainingCoupons(uint256 bond) public view virtual override returns (int256) {
   ...
   */
   ...
   function getCouponsRedeemed(uint256 bond) public view virtual override returns (uint256) {
   ...
   */
   ...
   function getTimesToRedeem() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getTerm() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getMaturity(uint256 bond) public view virtual override returns (uint256) {
   ...
   */
   ...
   function getSimpleInterest() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getCouponRate() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getParValue() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getCap() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getBalance(address who) public view virtual override returns (uint256) {
   ...
   */
   ...
   function getParDecimals() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getTokenToRedeem() public view virtual override returns (address) {
   ...
   */
   ...
   function getTotalDebt() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getTotalBonds() public view virtual override returns (uint256) {
   ...
   */
   ...
   function getCouponThreshold() public view virtual override returns (uint256) {
